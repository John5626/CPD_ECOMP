...
int main() {
    ...
    if(fout.is_open()) {
        ...
        for(int i = 10; i < N; i += 100) {
            ...
            //cout << i << " " << duration_cast<milliseconds>(intervalo).count() << "ms\n";
            cout << i << " " << duration_cast<microseconds>(intervalo).count() << endl; //"us\n";
            fout << i << " " << duration_cast<microseconds>(intervalo).count() << endl; //"us\n";
